...
class KBuilderTest(unittest.TestCase):
    ...
    def test_get_build_cross_compiler_prefix(self):
        """
        Ensure __get_build_cross_compiler_prefix() returns the CROSS_COMPILE
        environment variable.
        """
        # pylint: disable=W0212,E1101
        os.environ['CROSS_COMPILE'] = 'powerpc64-linux-gnu-'
        build = self.kbuilder
        result = build._KernelBuilder__get_build_cross_compiler_prefix()
